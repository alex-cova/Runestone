...
### 👋 Welcome to Runestone - a performant plain text editor for macOS with code editing features
...
Runestone targets macOS. The library is built and tested with `swift build` and `swift test` on macOS 12+.
